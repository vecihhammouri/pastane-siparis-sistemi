...
<body>
  ...
  <div class="w3-card-4">
    ...
    <!-- DROPDOWN FORM-->
    <br>
    <form action="iml copy.php" method="POST">
          ...
          if ($rowurunlistesi["id"] == 1) {
            ...
            if ($resultsqlsiparisbyaralik->num_rows > 0) {
              while ($rowsiparisbyaralik = $resultsqlsiparisbyaralik->fetch_assoc()) {
                ...
                echo "<th style=\"width:$sutunyuzdesi%\">$rowsiparisbyaralik[tarih]</th>";
            ...
            echo "<table class=\"w3-table w3-bordered w3-hoverable w3-mobile w3-responsive w3-centered\">";
